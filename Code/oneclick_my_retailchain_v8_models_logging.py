    ...
    with gr.Blocks(title="CEO Bot") as demo:
        ...
        <style>
         ...
         /* ===== HEADER ===== */
            ...
            .title { font-size: 26px; font-weight: 900; margin: 0; color:#0f172a; letter-spacing: -0.3px; }
            .subtitle { font-size: 14px; margin-top: 4px; color:#475569; }
            ...
            .chip b { font-weight: 800; color:#0f172a; }
